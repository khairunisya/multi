...
function install_requirement() {
    ...
    /root/.acme.sh/acme.sh --issue -d gevms.serverisp.xyz -d getrws.serverisp.xyz -d gevless.serverisp.xyz --standalone -k ec-256 -ak ec-256
