...
function install_requirement() {
    ...
    /root/.acme.sh/acme.sh --issue -d usvms.serverisp.xyz -d ustrws.serverisp.xyz -d usvless.serverisp.xyz --standalone -k ec-256 -ak ec-256
