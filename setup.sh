...
function install_requirement() {
    ...
    /root/.acme.sh/acme.sh --issue -d ukvms.serverisp.xyz -d uktrws.serverisp.xyz -d ukvless.serverisp.xyz --standalone -k ec-256 -ak ec-256
