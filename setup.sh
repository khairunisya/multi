...
function install_requirement() {
    ...
    /root/.acme.sh/acme.sh --issue -d sg2vms.serverisp.xyz -d sg2trws.serverisp.xyz -d sg2vless.serverisp.xyz --standalone -k ec-256 -ak ec-256
