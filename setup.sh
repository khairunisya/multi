...
function install_requirement() {
    ...
    /root/.acme.sh/acme.sh --issue -d sg3vms.serverisp.xyz -d sg3trws.serverisp.xyz -d sg3vless.serverisp.xyz --standalone -k ec-256 -ak ec-256
